...
const IPhoneContainer = ({ children }) => {
  return (
    <div className="bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 dark:from-indigo-700 dark:via-purple-700 dark:to-pink-700 rounded-[30px] shadow-md p-6 w-[280px] h-[498px] border-8 border-gray-300 rounded-[40px] relative overflow-hidden">
      {/* Speaker Section */}
